...
function initCursor(){
  ...
  // Desktop: apply cursor:none to html only, then show custom cursor
  // Inject style: hide default cursor everywhere, but keep pointer behavior for interactive elements
  if (!document.getElementById('cursor-style-global')) {
    var cs = document.createElement('style');
    cs.id = 'cursor-style-global';
